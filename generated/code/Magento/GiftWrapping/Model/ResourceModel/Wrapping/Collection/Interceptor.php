...
class Interceptor extends \Magento\GiftWrapping\Model\ResourceModel\Wrapping\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyWebsiteFilter');
        if (!$pluginInfo) {
            return parent::applyWebsiteFilter($websiteId);
        } else {
            return $this->___callPlugins('applyWebsiteFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyStatusFilter');
        if (!$pluginInfo) {
            return parent::applyStatusFilter();
        } else {
            return $this->___callPlugins('applyStatusFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoreAttributesToResult');
        if (!$pluginInfo) {
            return parent::addStoreAttributesToResult($storeId);
        } else {
            return $this->___callPlugins('addStoreAttributesToResult', func_get_args(), $pluginInfo);
        }
    }
