...
class Interceptor extends \Magento\CatalogEvent\Model\ResourceModel\Event\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addVisibilityFilter');
        if (!$pluginInfo) {
            return parent::addVisibilityFilter();
        } else {
            return $this->___callPlugins('addVisibilityFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCategoryData');
        if (!$pluginInfo) {
            return parent::addCategoryData();
        } else {
            return $this->___callPlugins('addCategoryData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSortByStatus');
        if (!$pluginInfo) {
            return parent::addSortByStatus();
        } else {
            return $this->___callPlugins('addSortByStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addImageData');
        if (!$pluginInfo) {
            return parent::addImageData();
        } else {
            return $this->___callPlugins('addImageData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'capByCategoryPaths');
        if (!$pluginInfo) {
            return parent::capByCategoryPaths($allowedPaths);
        } else {
            return $this->___callPlugins('capByCategoryPaths', func_get_args(), $pluginInfo);
        }
    }
