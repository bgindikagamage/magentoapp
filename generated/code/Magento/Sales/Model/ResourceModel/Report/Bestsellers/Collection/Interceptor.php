...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Report\Bestsellers\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addStoreRestrictions($storeIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::addStoreRestrictions($storeIds);
        } else {
    ...
    public function addOrderStatusFilter($orderStatus)
    {
        ...
        if (!$pluginInfo) {
            return parent::addOrderStatusFilter($orderStatus);
        } else {
            return $this->___callPlugins('addOrderStatusFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAggregatedColumns(array $columns)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAggregatedColumns($columns);
        } else {
            return $this->___callPlugins('setAggregatedColumns', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAggregatedColumns()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAggregatedColumns();
        } else {
            return $this->___callPlugins('getAggregatedColumns', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setPeriod($period)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setPeriod', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isTotals($flag = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::isTotals($flag);
        } else {
            return $this->___callPlugins('isTotals', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isSubTotals()
    {
        ...
        if (!$pluginInfo) {
            return parent::isSubTotals();
        } else {
            return $this->___callPlugins('isSubTotals', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setIsSubTotals($flag)
    {
        ...
        if (!$pluginInfo) {
            return parent::setIsSubTotals($flag);
        } else {
            return $this->___callPlugins('setIsSubTotals', func_get_args(), $pluginInfo);
        }
    }
