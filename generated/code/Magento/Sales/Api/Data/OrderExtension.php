...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
    ...
    /**
     * @return \Magento\Company\Api\Data\CompanyOrderInterface|null
     */
    public function getCompanyOrderAttributes()
    {
        return $this->_get('company_order_attributes');
    }

    /**
     * @param \Magento\Company\Api\Data\CompanyOrderInterface $companyOrderAttributes
     * @return $this
     */
    public function setCompanyOrderAttributes(\Magento\Company\Api\Data\CompanyOrderInterface $companyOrderAttributes)
    {
        $this->setData('company_order_attributes', $companyOrderAttributes);
        return $this;
    }
