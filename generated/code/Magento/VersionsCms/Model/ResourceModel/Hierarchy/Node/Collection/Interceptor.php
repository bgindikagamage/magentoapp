...
class Interceptor extends \Magento\VersionsCms\Model\ResourceModel\Hierarchy\Node\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinCmsPage');
        if (!$pluginInfo) {
            return parent::joinCmsPage();
        } else {
            return $this->___callPlugins('joinCmsPage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCmsPageInStoresColumn');
        if (!$pluginInfo) {
            return parent::addCmsPageInStoresColumn();
        } else {
            return $this->___callPlugins('addCmsPageInStoresColumn', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTreeOrder');
        if (!$pluginInfo) {
            return parent::setTreeOrder();
        } else {
            return $this->___callPlugins('setTreeOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setOrderByLevel');
        if (!$pluginInfo) {
            return parent::setOrderByLevel();
        } else {
            return $this->___callPlugins('setOrderByLevel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinMetaData');
        if (!$pluginInfo) {
            return parent::joinMetaData();
        } else {
            return $this->___callPlugins('joinMetaData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinPageExistsNodeInfo');
        if (!$pluginInfo) {
            return parent::joinPageExistsNodeInfo($page);
        } else {
            return $this->___callPlugins('joinPageExistsNodeInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyPageExistsOrNodeIdFilter');
        if (!$pluginInfo) {
            return parent::applyPageExistsOrNodeIdFilter($nodeIds, $page);
        } else {
            return $this->___callPlugins('applyPageExistsOrNodeIdFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLastChildSortOrderColumn');
        if (!$pluginInfo) {
            return parent::addLastChildSortOrderColumn();
        } else {
            return $this->___callPlugins('addLastChildSortOrderColumn', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyRootNodeFilter');
        if (!$pluginInfo) {
            return parent::applyRootNodeFilter();
        } else {
            return $this->___callPlugins('applyRootNodeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyScope');
        if (!$pluginInfo) {
            return parent::applyScope($scope);
        } else {
            return $this->___callPlugins('applyScope', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyScopeId');
        if (!$pluginInfo) {
            return parent::applyScopeId($codeId);
        } else {
            return $this->___callPlugins('applyScopeId', func_get_args(), $pluginInfo);
        }
    }
