...
class Interceptor extends \Magento\Banner\Model\ResourceModel\Catalogrule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addWebsiteCustomerGroupFilter($websiteId, $customerGroupId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addWebsiteCustomerGroupFilter($websiteId, $customerGroupId);
        } else {
            return $this->___callPlugins('addWebsiteCustomerGroupFilter', func_get_args(), $pluginInfo);
        }
    }
