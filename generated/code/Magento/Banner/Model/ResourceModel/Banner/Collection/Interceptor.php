...
class Interceptor extends \Magento\Banner\Model\ResourceModel\Banner\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoresVisibility');
        if (!$pluginInfo) {
            return parent::addStoresVisibility();
        } else {
            return $this->___callPlugins('addStoresVisibility', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addStoreFilter($storeIds, $withAdmin = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::addStoreFilter($storeIds, $withAdmin);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addBannerIdsFilter');
        if (!$pluginInfo) {
            return parent::addBannerIdsFilter($bannerIds, $exclude);
        } else {
            return $this->___callPlugins('addBannerIdsFilter', func_get_args(), $pluginInfo);
        }
    }
