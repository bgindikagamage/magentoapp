...
class Interceptor extends \Magento\Banner\Model\ResourceModel\Salesrule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addRuleIdsFilter(array $ruleIds) : \Magento\Banner\Model\ResourceModel\Salesrule\Collection
    {
        ...
        if (!$pluginInfo) {
            return parent::addRuleIdsFilter($ruleIds);
        } else {
            return $this->___callPlugins('addRuleIdsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addIsActiveSalesRuleFilter(int $isActive = 1) : \Magento\Banner\Model\ResourceModel\Salesrule\Collection
    {
        ...
        if (!$pluginInfo) {
            return parent::addIsActiveSalesRuleFilter($isActive);
        } else {
            return $this->___callPlugins('addIsActiveSalesRuleFilter', func_get_args(), $pluginInfo);
        }
    }
