<?php
namespace Magento\Company\Model\ResourceModel\Permission\Collection;

/**
 * Interceptor class for @see \Magento\Company\Model\ResourceModel\Permission\Collection
 */
class Interceptor extends \Magento\Company\Model\ResourceModel\Permission\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function toOptionHash($valueField = 'resource_id', $labelField = 'permission')
    {
        ...
        if (!$pluginInfo) {
            return parent::toOptionHash($valueField, $labelField);
        } else {
