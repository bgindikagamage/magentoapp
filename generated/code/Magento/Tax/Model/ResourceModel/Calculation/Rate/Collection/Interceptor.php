...
class Interceptor extends \Magento\Tax\Model\ResourceModel\Calculation\Rate\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function joinCountryTable()
    {
        ...
        if (!$pluginInfo) {
            return parent::joinCountryTable();
        } else {
            return $this->___callPlugins('joinCountryTable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function joinRegionTable()
    {
        ...
        if (!$pluginInfo) {
            return parent::joinRegionTable();
        } else {
            return $this->___callPlugins('joinRegionTable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function joinTitle($store = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::joinTitle($store);
        } else {
            return $this->___callPlugins('joinTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function joinStoreTitles()
    {
        ...
        if (!$pluginInfo) {
            return parent::joinStoreTitles();
        } else {
            return $this->___callPlugins('joinStoreTitles', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addRateFilter($rateId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addRateFilter($rateId);
        } else {
            return $this->___callPlugins('addRateFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function toOptionHashOptimized()
    {
        ...
        if (!$pluginInfo) {
            return parent::toOptionHashOptimized();
        } else {
            return $this->___callPlugins('toOptionHashOptimized', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOptionRates()
    {
        ...
        if (!$pluginInfo) {
            return parent::getOptionRates();
        } else {
            return $this->___callPlugins('getOptionRates', func_get_args(), $pluginInfo);
        }
    }
