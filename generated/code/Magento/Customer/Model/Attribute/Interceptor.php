...
class Interceptor extends \Magento\Customer\Model\Attribute implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function canBeSearchableInGrid()
    {
        ...
        if (!$pluginInfo) {
            return parent::canBeSearchableInGrid();
        } else {
            return $this->___callPlugins('canBeSearchableInGrid', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function canBeFilterableInGrid()
    {
        ...
        if (!$pluginInfo) {
            return parent::canBeFilterableInGrid();
        } else {
            return $this->___callPlugins('canBeFilterableInGrid', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getValidateRules()
    {
        ...
        if (!$pluginInfo) {
            return parent::getValidateRules();
        } else {
            return $this->___callPlugins('getValidateRules', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setValidateRules($rules)
    {
        ...
        if (!$pluginInfo) {
            return parent::setValidateRules($rules);
        } else {
            return $this->___callPlugins('setValidateRules', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMultilineCount()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMultilineCount();
        } else {
            return $this->___callPlugins('getMultilineCount', func_get_args(), $pluginInfo);
        }
    }
