...
class TotalsExtension extends \Magento\Framework\Api\AbstractSimpleObject implements TotalsExtensionInterface
{
    ...
    {
        return $this->_get('negotiable_quote_totals');
    }

    /**
     * @param \Magento\NegotiableQuote\Api\Data\NegotiableQuoteTotalsInterface $negotiableQuoteTotals
     * @return $this
     */
    public function setNegotiableQuoteTotals(\Magento\NegotiableQuote\Api\Data\NegotiableQuoteTotalsInterface $negotiableQuoteTotals)
    {
        $this->setData('negotiable_quote_totals', $negotiableQuoteTotals);
        return $this;
    }
