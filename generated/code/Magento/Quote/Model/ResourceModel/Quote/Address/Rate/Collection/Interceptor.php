...
class Interceptor extends \Magento\Quote\Model\ResourceModel\Quote\Address\Rate\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setAddressFilter($addressId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAddressFilter($addressId);
        } else {
            return $this->___callPlugins('setAddressFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setFixedOnlyFilter($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::setFixedOnlyFilter($value);
        } else {
            return $this->___callPlugins('setFixedOnlyFilter', func_get_args(), $pluginInfo);
        }
    }
