<?php
namespace Magento\SharedCatalog\Model\ResourceModel\SharedCatalog\Collection;

/**
 * Interceptor class for @see \Magento\SharedCatalog\Model\ResourceModel\SharedCatalog\Collection
 */
class Interceptor extends \Magento\SharedCatalog\Model\ResourceModel\SharedCatalog\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinCustomerTable');
        if (!$pluginInfo) {
            return parent::joinCustomerTable();
        } else {
            return $this->___callPlugins('joinCustomerTable', func_get_args(), $pluginInfo);
        }
    }
