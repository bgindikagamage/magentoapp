...
class Interceptor extends \Magento\TargetRule\Model\ResourceModel\Rule\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addApplyToFilter($applyTo)
    {
        ...
        if (!$pluginInfo) {
            return parent::addApplyToFilter($applyTo);
        } else {
            return $this->___callPlugins('addApplyToFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setPriorityOrder($direction = 'ASC')
    {
        ...
        if (!$pluginInfo) {
            return parent::setPriorityOrder($direction);
        } else {
            return $this->___callPlugins('setPriorityOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addProductFilter($productId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addProductFilter($productId);
        } else {
    ...
    public function addSegmentFilter($segmentId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addSegmentFilter($segmentId);
        } else {
            return $this->___callPlugins('addSegmentFilter', func_get_args(), $pluginInfo);
        }
    }
