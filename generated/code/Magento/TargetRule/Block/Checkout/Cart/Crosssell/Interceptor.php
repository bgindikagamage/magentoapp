...
class Interceptor extends \Magento\TargetRule\Block\Checkout\Cart\Crosssell implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastAddedProductId');
        if (!$pluginInfo) {
            return parent::getLastAddedProductId();
        } else {
            return $this->___callPlugins('getLastAddedProductId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLastAddedProduct');
        if (!$pluginInfo) {
            return parent::getLastAddedProduct();
        } else {
            return $this->___callPlugins('getLastAddedProduct', func_get_args(), $pluginInfo);
        }
    }
