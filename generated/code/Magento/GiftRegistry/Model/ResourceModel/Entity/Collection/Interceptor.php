...
class Interceptor extends \Magento\GiftRegistry\Model\ResourceModel\Entity\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function filterByCustomerId($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::filterByCustomerId($id);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByActive');
        if (!$pluginInfo) {
            return parent::filterByActive();
        } else {
            return $this->___callPlugins('filterByActive', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRegistryInfo');
        if (!$pluginInfo) {
            return parent::addRegistryInfo();
        } else {
            return $this->___callPlugins('addRegistryInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applySearchFilters');
        if (!$pluginInfo) {
            return parent::applySearchFilters($params);
        } else {
            return $this->___callPlugins('applySearchFilters', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addWebsiteFilter($websiteIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::addWebsiteFilter($websiteIds);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByIsActive');
        if (!$pluginInfo) {
            return parent::filterByIsActive($status);
        } else {
            return $this->___callPlugins('filterByIsActive', func_get_args(), $pluginInfo);
        }
    }
