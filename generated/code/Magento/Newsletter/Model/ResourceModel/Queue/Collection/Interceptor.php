...
class Interceptor extends \Magento\Newsletter\Model\ResourceModel\Queue\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addTemplateInfo()
    {
        ...
        if (!$pluginInfo) {
            return parent::addTemplateInfo();
        } else {
            return $this->___callPlugins('addTemplateInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addSubscribersInfo()
    {
        ...
        if (!$pluginInfo) {
            return parent::addSubscribersInfo();
        } else {
            return $this->___callPlugins('addSubscribersInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addSubscriberFilter($subscriberId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addSubscriberFilter($subscriberId);
        } else {
            return $this->___callPlugins('addSubscriberFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addOnlyForSendingFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addOnlyForSendingFilter();
        } else {
            return $this->___callPlugins('addOnlyForSendingFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addOnlyUnsentFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addOnlyUnsentFilter();
        } else {
            return $this->___callPlugins('addOnlyUnsentFilter', func_get_args(), $pluginInfo);
        }
    }
