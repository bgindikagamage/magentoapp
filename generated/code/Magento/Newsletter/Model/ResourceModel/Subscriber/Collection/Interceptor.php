...
class Interceptor extends \Magento\Newsletter\Model\ResourceModel\Subscriber\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function useQueue(\Magento\Newsletter\Model\Queue $queue)
    {
        ...
        if (!$pluginInfo) {
            return parent::useQueue($queue);
        } else {
            return $this->___callPlugins('useQueue', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useOnlyUnsent()
    {
        ...
        if (!$pluginInfo) {
            return parent::useOnlyUnsent();
        } else {
            return $this->___callPlugins('useOnlyUnsent', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function showCustomerInfo()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('showCustomerInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addSubscriberTypeField()
    {
        ...
        if (!$pluginInfo) {
            return parent::addSubscriberTypeField();
        } else {
            return $this->___callPlugins('addSubscriberTypeField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function showStoreInfo()
    {
        ...
        if (!$pluginInfo) {
            return parent::showStoreInfo();
        } else {
            return $this->___callPlugins('showStoreInfo', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useOnlyCustomers()
    {
        ...
        if (!$pluginInfo) {
            return parent::useOnlyCustomers();
        } else {
            return $this->___callPlugins('useOnlyCustomers', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useOnlySubscribed()
    {
        ...
        if (!$pluginInfo) {
            return parent::useOnlySubscribed();
        } else {
            return $this->___callPlugins('useOnlySubscribed', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getQueueJoinedFlag()
    {
        ...
        if (!$pluginInfo) {
            return parent::getQueueJoinedFlag();
        } else {
            return $this->___callPlugins('getQueueJoinedFlag', func_get_args(), $pluginInfo);
        }
    }
