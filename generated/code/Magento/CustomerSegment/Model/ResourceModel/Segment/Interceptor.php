...
class Interceptor extends \Magento\CustomerSegment\Model\ResourceModel\Segment implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSegmentCustomersQty($segmentId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSegmentCustomersQty($segmentId);
        } else {
            return $this->___callPlugins('getSegmentCustomersQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function runConditionSql($sql, $bindParams)
    {
        ...
        if (!$pluginInfo) {
            return parent::runConditionSql($sql, $bindParams);
        } else {
            return $this->___callPlugins('runConditionSql', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function createSelect()
    {
        ...
        if (!$pluginInfo) {
            return parent::createSelect();
        } else {
            return $this->___callPlugins('createSelect', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function quoteInto($string, $param)
    {
        ...
        if (!$pluginInfo) {
            return parent::quoteInto($string, $param);
        } else {
    ...
    public function getSqlOperator($operator)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getSqlOperator', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function createConditionSql($field, $operator, $value)
    {
        ...
        if (!$pluginInfo) {
            return parent::createConditionSql($field, $operator, $value);
        } else {
            return $this->___callPlugins('createConditionSql', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getActiveSegmentsByIds($segmentIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::getActiveSegmentsByIds($segmentIds);
        } else {
            return $this->___callPlugins('getActiveSegmentsByIds', func_get_args(), $pluginInfo);
        }
    }
