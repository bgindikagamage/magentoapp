...
class Interceptor extends \Magento\CustomerSegment\Model\ResourceModel\Segment\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addEventFilter($eventName)
    {
        ...
        if (!$pluginInfo) {
            return parent::addEventFilter($eventName);
        } else {
            return $this->___callPlugins('addEventFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addCustomerCountToSelect()
    {
        ...
        if (!$pluginInfo) {
            return parent::addCustomerCountToSelect();
        } else {
            return $this->___callPlugins('addCustomerCountToSelect', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addCustomerCountFilter($customerCount)
    {
        ...
        if (!$pluginInfo) {
            return parent::addCustomerCountFilter($customerCount);
        } else {
            return $this->___callPlugins('addCustomerCountFilter', func_get_args(), $pluginInfo);
        }
    }
