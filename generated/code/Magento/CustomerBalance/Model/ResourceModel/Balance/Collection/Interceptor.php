...
class Interceptor extends \Magento\CustomerBalance\Model\ResourceModel\Balance\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addWebsitesFilter');
        if (!$pluginInfo) {
            return parent::addWebsitesFilter($websiteIds);
        } else {
            return $this->___callPlugins('addWebsitesFilter', func_get_args(), $pluginInfo);
        }
    }
