...
class Interceptor extends \Magento\Search\Model\ResourceModel\Query\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setQueryFilter');
        if (!$pluginInfo) {
            return parent::setQueryFilter($query);
        } else {
            return $this->___callPlugins('setQueryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setPopularQueryFilter');
        if (!$pluginInfo) {
            return parent::setPopularQueryFilter($storeIds);
        } else {
            return $this->___callPlugins('setPopularQueryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setRecentQueryFilter');
        if (!$pluginInfo) {
            return parent::setRecentQueryFilter();
        } else {
            return $this->___callPlugins('setRecentQueryFilter', func_get_args(), $pluginInfo);
        }
    }
