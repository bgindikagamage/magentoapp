...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Catalog\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsToProcess');
        if (!$pluginInfo) {
            return parent::getProductsToProcess($limit);
        } else {
            return $this->___callPlugins('getProductsToProcess', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterProductsByStoreTypeAndVisibility');
        if (!$pluginInfo) {
            return parent::filterProductsByStoreTypeAndVisibility($storeId, $productIds);
        } else {
            return $this->___callPlugins('filterProductsByStoreTypeAndVisibility', func_get_args(), $pluginInfo);
        }
    }
