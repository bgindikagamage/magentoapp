...
class SaveHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Magento\RequisitionList\Model\RequisitionListItem\Options\Builder|MockObject
     */
    ...
    /**
     * @var \Magento\RequisitionList\Model\RequisitionListItem\Locator|MockObject
     */
    ...
    public function testSaveItemDecimalQty($inputQty, $qtyToSave, bool $isQtyDecimal)
    {
        ...
        $productData = $this->createPartialMock(DataObject::class, ['getSku', 'getOptions']);
        if ($inputQty !== false) {
        ...
        $requisitionList = $this->createMock(RequisitionListInterface::class);
